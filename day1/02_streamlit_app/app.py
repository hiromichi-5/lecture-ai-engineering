...
# --- サイドバー ---
st.sidebar.markdown("<h2 style='text-align: center; color:#4A90E2;'>📋 ナビゲーション</h2>", unsafe_allow_html=True)

# セッション状態を使用して選択ページを保持
if "page" not in st.session_state:
    st.session_state.page = "チャット"  # デフォルトページ

page_icons = {"チャット": "💬", "履歴閲覧": "📊", "サンプルデータ管理": "🔧"}
...
page = st.sidebar.radio(
    ...
    format_func=lambda x: f"{page_icons[x]} {x}",  # アイコンを追加
)
